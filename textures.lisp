  ...
  (let ((ret (make-hash-table)))
	...
	(setf (gethash :pellet-white ret)
		  (make-sprite-descriptor
		   ...
		   :bounds (make-rectangle :x 176 :y 224 :width 16 :height 16)
	...
	(setf (gethash :red-fairy ret)
		  (make-sprite-descriptor
		   ...
		   :bounds (make-rectangle :x 0 :y 384 :width 32 :height 32)
	...
	(setf (gethash :focus-sigil ret)
		  (make-sprite-descriptor
		   ...
		   :bounds (make-rectangle :x 128 :y 0 :width 64 :height 64)
