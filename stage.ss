  ...
  (for-each
   (λ (aimed ring)
	 (-> (fb)
		 (fbcount 1 5)
		 (fbspeed 4.0 9.0)
		 (fbshootenm enm aimed 2 (sebundle-bell sounds)))
	 (-> (cb)
		 (cbcount 20 3)
		 (cbspeed 4.0 9.0)
		 (cbshoot (ex enm) (ey enm)
		   (λ (layer in-layer speed facing)
			 (when (not (zero? in-layer))
			   (-> (spawn-bullet
				   ...
				   (bullet-facing-set! facing))))))
	 (wait 48))
   '(heart-red heart-orange heart-blue heart-magenta)
   '(small-ball-red small-ball-orange small-ball-blue small-ball-magenta)))
...
(define (chapter12 task)
  ...
  (dotimes 25
	...
	(wait 5))
  (wait 105)
  (hint #x8b008bc0 -160.0 160.0)
  (hint #x8b008bc0 160.0 160.0)
  (hint #x8b008bc0 0.0 120.0)
  (wait 45)
  ...
  (wait 45)
  (hint #xdaa520c0 -160.0 32.0)
  (hint #xdaa520c0 160.0 32.0)
  (hint #xdaa520c0 -160.0 416.0)
  (hint #xdaa520c0 160.0 416.0)
  (wait 45)
  (raylib:play-sound (sebundle-oldvwoopfast sounds))
  ...
  (ch12-sswave 160.0 416.0 5 4.0 'pellet-yellow 'music-orange)
  (wait 25)
  (hint #x1e90ffc0 -160.0 224.0)
  (hint #x1e90ffc0 160.0 224.0)
  (hint #x1e90ffc0 0.0 32.0)
  (hint #x1e90ffc0 0.0 416.0)
  (wait 45)
  (raylib:play-sound (sebundle-oldvwoopfast sounds))
